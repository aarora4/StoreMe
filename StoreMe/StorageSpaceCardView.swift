...
class StorageSpaceCardView: UIView {
...
//        self.layer.shadowColor = UIColor.black.cgColor
        ...
        titleLabel = UILabel(frame: CGRect(x: 0, y: self.frame.height / 2 - 45, width: self.frame.width - 30, height: 45))
        titleLabel.center.x = self.frame.width / 2
        titleLabel.text = "CULC 421"
